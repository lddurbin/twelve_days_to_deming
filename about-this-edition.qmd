...
pagetitle: "About this edition: why and how this web adaptation was built"
description: "Why Lee Durbin adapted 12 Days to Deming for the web, what changed from Neave's original PDFs, and the author's personal blessing for this edition."
execute:
  echo: false
---
...
Under most chapter titles you'll see a small note like *"~ 6 min reading"* or *"~ 6 min reading · ~ 20 min at Neave's pace."* These measure two different things:

- **Reading time** is a plain word count divided by an average reading speed. It only tells you how long the prose takes to read.
- **At Neave's pace**, when it's shown, is Dr Neave's own timing for that section, read from the clock faces printed in the margins of his original course material. It's how long he allowed a room of course participants to spend there — so it covers reflection, activities, and time on the figures, not just reading the words.

The two numbers can differ a lot in either direction, and that's the point: a short passage Dr Neave wanted you to sit with for half an hour tells you something a word count can't.

On Day 2 you may also see a third figure, like *"(~ 30 min on Stats-level 0)"*. Dr Neave printed two columns of clocks on those pages — one pace for readers who chose Stats-level 0 back in the [Welcome](welcome.qmd), another for those on Stats-levels 1 to 3. The two paces are the same for most chapters; where they differ, both are shown.

Most chapters currently show reading time only, with no second figure. That isn't a signal that the two are roughly equal — it's simply that Dr Neave's timings for that part of the course haven't been transcribed into the site yet. Days 1 and 2 are covered today; the rest of the course will follow as that work continues. Treat a bare reading-time figure as a floor on how long the chapter will take, not a full estimate.
...
## Feedback, contributions, and reporting issues

There are three ways to tell me something, and the right one depends on what you want to say. None of them require an account.

**If a chapter worked for you, or didn't**, use the thumbs up or down at the foot of it. A thumbs-down opens an optional box for the detail — what was confusing, what was broken, what you expected instead. It takes one click, and because it knows which chapter you were on, it tells me *where* something went wrong in a way a general message about the site can't. What that sends, and what it deliberately doesn't, is set out on the [Privacy](privacy.qmd) page.

**If you'd be happy to be quoted**, there's a short form on the [Share Your Experience](share-your-experience.qmd) page. This edition exists partly because people took the trouble to say the course was worth their time, and a few sentences from you would help the next person decide the same. Nothing gets published unless you explicitly choose that option, and you can say yes anonymously.

**If you're comfortable on GitHub**, the site lives at [github.com/lddurbin/twelve_days_to_deming](https://github.com/lddurbin/twelve_days_to_deming) and I welcome contributions of all sizes. If you spot a typo, a broken link, a cross-reference that doesn't resolve, or anything else that looks wrong, please [open an issue](https://github.com/lddurbin/twelve_days_to_deming/issues/new) or a pull request. Suggestions for new activities, improvements to existing ones, or additional accessibility features are just as valuable as bug reports — if you're not sure whether something is worth raising, raise it anyway. I'd rather hear about small issues than miss them.
