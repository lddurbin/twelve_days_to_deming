...
# Emit chart figures as external SVG files (via svglite) instead of PNG.
# Quarto wraps them as `<img src="…svg">`; the dark-mode re-skin happens
# via the CSS `filter: invert(1) hue-rotate(180deg)` rule in
# assets/styles/main.css, which flips brightness for axis ink/gridlines
# while the hue-rotate keeps chromatic colours (the red data line, the
...
source(file.path("R", "functions", "deviations-log.R"))
