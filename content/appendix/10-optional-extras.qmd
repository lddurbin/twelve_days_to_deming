...
I'll ask you to look one more time at the Optional Extras, this time on [page 49](optional-extras/04-part-d-crash-course.qmd#sec-optional-extras-part-d). Here we have the same pictures as you saw two pages earlier ([page 47](optional-extras/04-part-d-crash-course.qmd#sec-optional-extras-part-d)) but now with those pictures divided into sections, each being of width σ and with percentages stated of the total area under the curve in each section. Rather similar to the way that the area under a section of a histogram corresponds to the *proportion* of the data that lie in that section, the [percentages printed on page 49 of the Optional Extras](optional-extras/04-part-d-crash-course.qmd#sec-optional-extras-part-d) indicate the *probabilities* that an observed value from the normal distribution lies in each of the different sections. Notice that those probabilities are exactly the same in each diagram, never mind how narrow or wide the bell-shape happens to be. This is actually an almost unique property of the normal distribution, and is one of the reasons that Mathematical Statisticians are so fond of it.
...
Actually, if you want to measure "quality", a little mathematics shows that Taguchi's study of "loss" leads to a very neat criterion. (For those who are interested, the "little mathematics" needed is very similar to the "useful trick" used on [Optional Extras page 81](optional-extras/06-part-f-technical.qmd#sec-optional-extras-part-f).) That criterion expresses the Average Taguchi Loss as simply being proportional to
