...
Some similar simulation work is reported in Chapter 4 of Wheeler and Chambers' *Understanding Statistical Process Control*. Three further distributions are illustrated there. I'll use just one of them here: this is the exponential distribution, whose pdf is shown alongside. It's a distribution which is used as a model in many situations including failure analysis and queuing theory, but its main interest here is as one of the most *un*symmetric distributions imaginable.
