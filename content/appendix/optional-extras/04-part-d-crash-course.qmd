...
#| fig-alt: "Bar histogram of 10,000 body-temperature readings rounded to the nearest integer degree Celsius. The three visible bars (36, 37, 38) have very nearly the same relative heights as in the 1,000-reading version, with the normal curve overlaid to hint at the underlying smooth distribution."
#| fig-width: 7
#| fig-height: 5
set.seed(353)
