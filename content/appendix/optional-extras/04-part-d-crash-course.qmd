...
A more organised way of dealing with *all* binomial distributions is presented in the [Technical Section on pages 85–89](06-part-f-technical.qmd#sec-optional-extras-part-f).
...
On [pages 90–91 in the Technical Section](06-part-f-technical.qmd#sec-optional-extras-part-f) I shall describe how the probability of any normal random variable lying within any specific interval can be quickly found using widely-available tables of the normal distribution.
...
The expression in the denominator of *Z* is the *standard deviation* of $\bar{X}$: this will be proved in the [Technical Section on page 80](06-part-f-technical.qmd#sec-optional-extras-part-f). That expression is obviously consistent with a fact which we know to be true, i.e. that, as the sample size increases, the variability of $\bar{X}$ keeps getting smaller (so that it approximates the value of μ better and better).
