...
pagetitle: "Appendix: references, sources, and further reading"
description: "The course's full bibliography — books, BDA booklets, videos, and contact links for Deming and Shewhart's own writing plus the wider Deming community."
execute:
  echo: false
---
...
(Note that and [0]{.underline} and [1]{.underline} are digits and [O]{.underline} and [I]{.underline} are capital letters.)

*A Prophet Unheard*: <https://www.youtube.com/playlist?list=PLCADAD3F2F91BD570>
...
Deming Transformation Forum (UK): [www.deming.org.uk](https://web.archive.org/web/20120105232234/http://www.deming.org.uk/)

> *NB*  The Deming Transformation Forum's website is no longer online. The linked 2012 archived snapshot is preserved here as a historical reference; the Booklets referenced throughout this course are no longer available via its former "Learning Store".
...
*Management's Five Deadly Diseases*: <https://www.youtube.com/watch?v=ehMAwIHGN0Y>
...
*Some colleagues (see my Preface in the ["A. PLEASE START HERE"](../../index.qmd) file) and I have made considerable efforts to trace copyright holders of content quoted in the course material.  I would welcome correspondence from any that we have missed or been unable to trace.*
