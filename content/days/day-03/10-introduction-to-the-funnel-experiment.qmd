...
```{r funnel-track-with-icons, fig.width=9, fig.height=1.5, fig.align="center", fig.cap="The same 20–40 track, now with two markers above it: a blue downward arrow above square 31 (the funnel's position) and a small yellow circle above square 33 (where the marble came to rest)."}
