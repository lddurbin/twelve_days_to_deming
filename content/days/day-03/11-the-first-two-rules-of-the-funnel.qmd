...
html`<div class="fe-status">
  ...
  ${rule2Counter > 0 ? ` | Last outcome: <strong style="color:#cc0000">${rule2Visible[rule2Visible.length - 1].marblePos}</strong>` : ""}
  ${rule2Counter > 0 ? ` | Funnel now at: <strong style="color:#3366cc">${rule2Visible[rule2Visible.length - 1].funnelAfter}</strong>` : ` | Funnel at: <strong style="color:#3366cc">${TARGET}</strong>`}
</div>`
```
...
html`<div class="fe-status">
  ...
  ${rule1Counter > 0 ? ` | Last outcome: <strong style="color:#cc0000">${rule1Visible[rule1Visible.length - 1].marblePos}</strong>` : ""}
  | Funnel always at: <strong style="color:#3366cc">${TARGET}</strong>
</div>`
```
