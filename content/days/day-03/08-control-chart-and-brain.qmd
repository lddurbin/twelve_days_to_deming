...
pagetitle: "Day 3: Interpreting control charts needs judgment, not just rules"
description: "Why reading a control chart well means combining the rules with judgment and subject knowledge, not mechanically checking if points cross a line."
execute:
  echo: false
---
...
It is interesting to reflect again on the artificial sales data ([pages 10 to 12, in the More on the Sales Data section above](04-more-on-the-sales-data.qmd#sec-page10)). It concerned a new product on the market. Surely we would not *expect* that process to be in statistical control in its early days: we would presumably be expecting, or at least hoping for, sales to increase from the starting-point of zero! So it would indeed have been a surprise to see the indication of stability in the control chart on [page 11, in the More on the Sales Data section above](04-more-on-the-sales-data.qmd#sec-page11). But, rather than the management team's almost automatic reactions, maybe it would have been wise to heed the control chart's guidance after all. Why might sales keep dropping as soon as the promotions stop? Maybe it *is* a system problem. Maybe the product is of poor quality or too expensive, so that those who buy it during a promotion do not buy it again and also recommend their friends and colleagues not to buy it either! Thus the problem might, after all, be in the system as the control chart indicates, pointing to the need to change the system by improving the product or charging a more realistic price.
...
There are other types of indications of special causes that can be seen even without the help of control limits. Examples are apparent trends (as we have seen on [page 8, in the Importance of Time section above](03-the-importance-of-time.qmd#sec-page8)) or a special cause might simply shift the process average up or down (as discussed on [page 14, in the How Do We Compute Those Control Limits section above](05-how-do-we-compute-control-limits.qmd#sec-page14)). Another example, particularly if we are dealing with monthly data, is some kind of seasonal effect. You may have noticed that there was a hint of such an effect in Chart F1 on [page 19](06-six-processes.qmd#sec-page19) (if so, well done!) but, as it was not large enough to send any points outside the control limits, I didn't mention it at the time. I'll comment more on this matter on [page 33, in the Six Processes Revisited section below](09-the-six-processes-revisited.qmd#sec-page33).
...
In the context of the "favourite example" (on [pages 24 to 25, above](08-control-chart-and-brain.qmd#sec-page24)), those data-points were of course far too comfortably contained between the control limits!
