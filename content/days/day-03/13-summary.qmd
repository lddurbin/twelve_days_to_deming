---
title: "SUMMARY"
pagetitle: "Day 3: Summary — tampering vs improving the system"
description: "Day 3's summary: comparing all four Rules of the Funnel confirms that tampering with a stable process only makes things worse than leaving it alone."
execute:
  echo: false
---
## Summary {#sec-page56}
...
```{ojs}
{
  ...
  return html`<div class="fe-summary-table-container" tabindex="0">
...
Let's first précis the "How Do We Compute Those Control Limits—and Why?" section on [pages 13–15](05-how-do-we-compute-control-limits.qmd#sec-page13) as follows:
...
viewof activity_3i = persist(
  "content/days/day-03/13-summary.qmd#activity_3i",
  Inputs.textarea({
...
Reveal suggested answer for Activity 3-i
</button>
...
*(For discussion see [Appendix pages 18–20](../../appendix/03-day-3.qmd#sec-page18).)*
</div>
</div>
...
```{ojs}
viewof activity_3j = persist(
  "content/days/day-03/13-summary.qmd#activity_3j",
  Inputs.textarea({
...
### Approvals, Acknowledgments and Information {#sec-page62}

^a^ ([page 5, the Ford Motor Company example](02-at-the-ford-motor-company.qmd#sec-page5)) The Ford Motor Company example and diagrams are included with the approval of Bill Scherkenbach.

^b^ ([page 32, the quotations from *Understanding Statistical Process Control*](09-the-six-processes-revisited.qmd#sec-page32)) This and all other quotations from *Understanding Statistical Process Control* have been reproduced with the approval of SPC Press Inc.
