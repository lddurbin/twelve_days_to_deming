...
pagetitle: "Day 3: Variation, the enemy of quality — the school bus story"
description: "Neave's school-bus story shows why variation matters more than the average, then Deming's Western Electric account introduces common and special causes."
session_minutes: 55
execute:
  echo: false
---
## Variation—the enemy of quality {#sec-page1}
...
## BACK TO THE WESTERN ELECTRIC COMPANY {#sec-page2}
...
viewof activity_3a_1 = persist(
  "content/days/day-03/01-variation-the-enemy-of-quality.qmd#activity_3a_1",
  Inputs.textarea({label: "Possible causes of variation in the school bus arrival-time", placeholder: "Type your suggestions here.", rows: 8})
)
```

Unsurprisingly, I do not have any data available from all those decades ago from which we could construct control charts. So, with each of the causes you've suggested above, simply say whether you think the cause is likely to have been common or special, and why. (Be guided by the paragraph on prison riots that we have just seen on [page 2, in the Back to the Western Electric Company section above](01-variation-the-enemy-of-quality.qmd#sec-page2).)

```{ojs}
viewof activity_3a_2 = persist(
  "content/days/day-03/01-variation-the-enemy-of-quality.qmd#activity_3a_2",
  Inputs.textarea({label: "Is each cause likely common or special, and why?", placeholder: "Type your comments here.", rows: 8})
)
```
...
```{ojs}
viewof activity_3b_1 = persist(
  "content/days/day-03/01-variation-the-enemy-of-quality.qmd#activity_3b_1",
  Inputs.textarea({label: "Is there a conflict between variety being good and variation being bad?", placeholder: "Type your comments here.", rows: 8})
)
```
...
```{ojs}
viewof activity_3b_2 = persist(
  "content/days/day-03/01-variation-the-enemy-of-quality.qmd#activity_3b_2",
  Inputs.textarea({label: "How might reducing variation lead to increasing variety?", placeholder: "Type your comments here.", rows: 8})
)
```

<div class="activity_afterthought">(For discussion see [Appendix page 14](../../appendix/03-day-3.qmd#sec-page14).)</div>
</div>
