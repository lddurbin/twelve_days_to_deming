...
pagetitle: "Day 2: Inside the Red Beads apparatus and its control limits"
description: "The mechanics of the Red Beads apparatus and training procedure, framed through the 'All-Knowing' vs 'Un-Knowing' lens, plus how to compute control limits."
session_minutes: 45
# Stats-level 0 readers are invited to skip the three Technical Aids
# (see the note before Technical Aid 1) — 15 min less on Neave's clocks.
...
[]{#sec-page20}But now here's a different "Of course". Of course, if our Un-Knowing friend wasn't *totally* unknowing, but had one special piece of knowledge, he might stand a chance of realising that those thoughts in the previous paragraph are all nonsense—even without understanding any technical details of the work at all. What would that special piece of knowledge be? *How to draw a control chart and interpret it.*

We have already seen on [page 15, in Our First Control Chart](04-our-first-control-chart.qmd#sec-page15) the control chart for the results recorded by Dec, and what it tells us in the Pause for Thought 2–e. (If you need reminding, look again at the bottom of [Appendix page 7](../../appendix/02-day-2.qmd#sec-page7).) Now, if we slip into the role of the All-Knowing, we *know* that what the control chart told us is surely true. How *could* this process of drawing 50 beads out of the container be anything other than in statistical control, i.e. stable? In fact, it must be one of the most stable processes imaginable! So it is indeed true that, as was stated in the Appendix, "essentially all the variation in the results is due to common causes, to the system, not in any way to the Willing Workers". *The control chart has told the Un-Knowing what the All-Knowing already knew to be true!* In most practical situations, of course, we do not have the benefit of the All-Knowing's knowledge. So we need to be guided by the control chart's intelligence instead. And it doesn't often let us down.
...
Let me remind you that those who have opted for Stats-level 0 are invited to skip the Technical Aids! Thus, if you have elected to be on Stats-level 0 (or 00), please now move straight on to [page 22, at the start of Your Turn](06-your-turn.qmd#sec-page22).
...
See if you can use this method to obtain the control limits quoted on [page 14, in Our First Control Chart](04-our-first-control-chart.qmd#sec-page14) and drawn on [page 15, in Our First Control Chart](04-our-first-control-chart.qmd#sec-page15). Use all 24 numbers of red beads in your calculation. (If you need help, the computations are sketched out in Technical Aid 2 on the next page—but try it by yourself first in the space at the top of the page.)
</div>

<div class="technical_aid" role="note" aria-label="Working space for Technical Aid 1">

```{ojs}
import { persist } from "../../../assets/scripts/workbook.js"

viewof working_ta1 = persist(
  "content/days/day-02/05-the-truth-the-whole-truth-and-nothing-but.qmd#working_ta1",
  Inputs.textarea({
  label: "Your working",
  placeholder: "Try the calculation yourself in this space before checking Technical Aid 2 on the next page. Use the Download button at the bottom of the page to save your working into your notes.",
  rows: 8
})
)
```
...
Firstly, notice that Dec recorded the total number of red beads obtained in the experiment near the bottom right of his table on [page 11, in A Brief Overview](03-a-brief-overview.qmd#sec-page11): it was 235. But now you'll need your calculator.
