...
pagetitle: "Day 2: The Red Beads control chart — all just common-cause variation"
description: "Plotting the Red Beads data on a control chart shows every result within the limits, proving the workers' scores were common-cause variation, not skill."
session_minutes: 25
execute:
  echo: false
---
We have now seen our first set of what were referred to yesterday as "process data" (other than the set illustrated on today's first page). We certainly have a process: meticulously defined by the Foreman during the training period. And we have some time-ordered data from that process: the 24 consecutive numbers of red beads recorded by Dec, the Recorder, in his table on [page 11, in A Brief Overview](03-a-brief-overview.qmd#sec-page11).
...
There are two stages in constructing a control chart. []{#sec-page14}The first stage is simply to draw a run chart of the data; so here it is:
...
## PAUSE FOR THOUGHT 2–e {#sec-page16}
What does the control chart on [page 15, above](04-our-first-control-chart.qmd#sec-page15) tell you?

```{ojs}
import { persist } from "../../../assets/scripts/workbook.js"

viewof thought_2e = persist(
  "content/days/day-02/04-our-first-control-chart.qmd#thought_2e",
  Inputs.textarea({label: "What does the control chart tell you?", placeholder: "Type your comments here.", rows: 10})
)
```

*(For brief but very important discussion, see [Appendix page 7](../../appendix/02-day-2.qmd#sec-page7) one more time.)*
</div>
