...
Here are all your Foreman reactions to the statisticians’ and the Spaniards’ results — set against the fact that both sets are nothing more than common-cause variation.
...
```{ojs transcript_2e}
{
  ...
  if (!filled.length) {
    return html`<p role="status"><em>No Foreman reactions yet — scroll up and play the role through all four weeks. Your comments will appear here as a transcript.</em></p>`;
  }
