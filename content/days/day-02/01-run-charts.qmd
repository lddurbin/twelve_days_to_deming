---
title: "RUN CHARTS"
pagetitle: "Day 2: Run charts, and why every sales wiggle looks meaningful"
description: "A monthly sales example shows how a run chart makes trends visible, and how management reacts to random monthly ups and downs as if each were meaningful."
session_minutes: 35
execute:
  echo: false
---
...
![Run chart of a value tracked daily from August to December: a steep fall through September, a sharp recovery at the start of October, a jump at the start of November, and an abrupt drop at the start of December](/assets/images/day-02/Picture%201.jpg){.lightbox}
...
## PAUSE FOR THOUGHT 2–a {#sec-page4}
...
viewof thought_2a = persist(
  "content/days/day-02/01-run-charts.qmd#thought_2a",
  Inputs.textarea({label: "Was this a reasonable account of how management might have reacted?", placeholder: "Type your comments here.", rows: 10})
)
```
...
Reveal suggested answer for Pause for Thought 2-a
</button>
