...
pagetitle: "Day 7: More true stories of targets gone wrong"
description: "Real accounts of nail factories, railway timetable padding, spiky chairs and fudged KPIs — how numerical targets invite gaming rather than improvement."
execute:
  echo: false
---
[]{#sec-page9}

Having assembled my collection of short true stories for Day 6, I copied it to a few friends and asked if they might have any further such contributions. These next nine pages show the results of that request! Some accounts may remind you of true stories of your own: if so, record them for use in Activity 7–d on [page 18, below](04-many-more-true-stories.qmd#sec-page18). I suggest you immediately make relevant notes for that Activity as you read through these pages.
...
### How to rise up the OFSTED league tables {#sec-page13}
...
The letter to *The Independent* newspaper shown alongside was published on 18 November 2000. Since it is a rather poor copy, you may find it a little difficult to read. Therefore, just in case, the second item on [Appendix page 31](../../appendix/06-day-7.qmd#sec-page31) provides a transcription.
...
*The earlier story (on [page 11, above](04-many-more-true-stories.qmd#sec-page11)) about the four types of blade needed for aircraft engines was reminiscent of one told at an Annual Conference of the British Deming Association. Here it is, along with two others:*
...
UK readers may have recognised several parallels between the above account and something that happened some five years later and led to the resignation from the Government of Ms Amber Rudd in April 2018. The third item on [Appendix page 31](../../appendix/06-day-7.qmd#sec-page31) provides a brief summary.

<div class="thought" role="note" aria-label="Activity">

## ACTIVITY 7–d

(a) If you have not already been doing so while reading through those stories, please return to Category 3 in both Activity 7–a ([page 4](02-numerical-targets.qmd#sec-page4)) and Activity 7–b ([page 5](02-numerical-targets.qmd#sec-page5)) and add some more to your answers there.

(b) The space below is left for some brief notes on your own true stories (see the top of [page 9](04-many-more-true-stories.qmd#sec-page9)).

```{ojs}
import { persist } from "../../../assets/scripts/workbook.js"

viewof activity_7d = persist(
  "content/days/day-07/04-many-more-true-stories.qmd#activity_7d",
  Inputs.textarea({label: "Brief notes on your own true stories of numerical targets", placeholder: "Type your own true stories here.", rows: 10})
)
```
