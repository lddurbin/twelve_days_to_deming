...
pagetitle: "Day 7: Reflecting on the Taguchi loss function"
description: "Why the Taguchi loss function justifies continual improvement and centring a process, while conformance-to-specifications thinking says 'good enough'."
session_minutes: 40
execute:
  echo: false
---
...
viewof thought_7f = persist(
  "content/days/day-07/06-taguchi-reflections.qmd#thought_7f",
  Inputs.textarea({label: "What does the parabola shape of the Taguchi loss function tell you about how loss varies with temperature?", placeholder: "Type your comments here.", rows: 10})
)
```
...
```{ojs}
viewof thought_7g = persist(
  "content/days/day-07/06-taguchi-reflections.qmd#thought_7g",
  Inputs.textarea({label: "What shape of loss function would justify 'conformance to specifications' thinking?", placeholder: "Type your comments here.", rows: 10})
)
```
...
&nbsp;&nbsp;&nbsp;&nbsp; *Taguchi loss function* (illustrated on [page 22, in The Thirteenth Obstacle](05-thirteenth-obstacle.qmd#sec-page22)):
...
```{ojs}
viewof thought_7h = persist(
  "content/days/day-07/06-taguchi-reflections.qmd#thought_7h",
  Inputs.textarea({label: "What do the two loss functions tell you about (1) the need for continual improvement and (2) keeping a process properly centred?", placeholder: "Type your comments here.", rows: 10})
)
```
