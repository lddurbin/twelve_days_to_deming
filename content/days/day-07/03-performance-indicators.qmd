...
pagetitle: "Day 7: Why performance indicators can't indicate performance"
description: "Performance indicators are singular and local, but performance is multi-faceted and systemic — plus how Peter Scholtes phased out appraisal, not banned it."
execute:
  echo: false
---
...
## PAUSE FOR THOUGHT 7–c {#sec-page6}
...
viewof thought_7c = persist(
  "content/days/day-07/03-performance-indicators.qmd#thought_7c",
  Inputs.textarea({label: "What two particular problems with performance indicators can you think of?", placeholder: "Type your comments here.", rows: 10})
)
```
